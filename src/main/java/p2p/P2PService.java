...
public class P2PService {
    ...
    public final static int QUERY_LATEST_BLOCK=0;  //查最新区块
    public final static int QUERY_BLOCKCHAIN=1;     //查询整个区块链
    public final static int QUERY_TRANSACTION=2;    //查询交易集合
    public final static int QUERY_PACKED_TRANSACTION=3; //查询已打包交易集合
    public final static int QUERY_WALLET=4;  //查询钱包集合
    public final static int RESPONSE_BLOCKCHAIN=5;   //返回区块
    public final static int RESPONSE_TRANSACTION=6;   //返回交易
